...
public class Movie{
	...
	private float imdb;
	@NotEmpty
	@Pattern(regexp = "^[A-Za-z ]+$",message="The director name should be combination of letters")
	...
	public Movie(int id,
			...
			@NotNull float imdb,
			@NotEmpty @Pattern(regexp = "^[A-Za-z ]+$", message = "The director name should be combination of letters") String director,
	...
	public String toString() {
		return "Movie [id=" + id + ", name=" + name + ", imdb=" + imdb + ", director=" + director + ", genre="
				+ genre + "]";
	}
